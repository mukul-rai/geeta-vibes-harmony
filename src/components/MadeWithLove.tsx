...
const MadeWithLove = () => {
  return (
    <div className="relative py-12 overflow-hidden">
      ...
      {/* Enhanced floating particles with refined animation */}
      ...
      <div className="relative mx-auto max-w-xs">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="relative inline-block">
            <div className="absolute -inset-1 bg-gradient-to-r from-saffron-200/70 via-maroon-200/70 to-saffron-200/70 dark:from-saffron-800/20 dark:via-maroon-800/20 dark:to-saffron-800/20 rounded-full blur-md opacity-50 animate-pulse" style={{animationDuration: '4s'}}></div>
            <div className="relative bg-white/90 dark:bg-earth-800/90 rounded-full px-5 py-2.5 shadow-sm border border-saffron-100/80 dark:border-saffron-900/20 flex items-center">
              <Sparkles size={14} className="text-saffron-500 dark:text-saffron-400 mr-2" />
              ...
              <Sparkles size={14} className="text-saffron-500 dark:text-saffron-400 ml-2" />
            </div>
          </div>
          
          {/* Heart animation with refined pulse effect */}
          ...
          {/* Sanskrit symbol with refined styling */}
