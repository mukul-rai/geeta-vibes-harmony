      ...
      <div className="pt-8 px-4 pb-8">
          ...
          <div className="flex justify-center mb-3">
            <div className="relative">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <BookOpen size={24} className="text-saffron-600 dark:text-saffron-400 m-2" />
              </div>
            </div>
          </div>
          <span className="inline-block px-4 py-1.5 rounded-full bg-gradient-to-r from-saffron-50 via-saffron-100 to-saffron-50 dark:from-saffron-900/20 dark:via-saffron-900/30 dark:to-saffron-900/20 text-saffron-800 dark:text-saffron-300 font-medium text-sm mb-3 flex items-center justify-center">
            Bhagavad Gita
          </span>
        ...
        <div className="bg-white/80 dark:bg-earth-800/80 backdrop-blur-sm rounded-lg shadow-sm border border-earth-100 dark:border-earth-700 p-5 mb-8 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-sm font-medium bg-saffron-50 dark:bg-saffron-900/30 text-saffron-600 dark:text-saffron-300 px-2 py-0.5 rounded-full flex items-center justify-center">
          ...
          <div className="relative">
            ...
            {completionPercentage > 0 && (
              <div 
                className="absolute top-1/2 transform -translate-y-1/2 w-3 h-3 rounded-full bg-saffron-500 dark:bg-saffron-400 border-2 border-white dark:border-earth-800 z-10 flex items-center justify-center"
